...
using Lykke.Service.BitcoinCash.API.Middleware;
using Lykke.Service.BitcoinCash.API.Modules;
...
namespace Lykke.Service.BitcoinCash.API
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                {
                    options.DefaultLykkeConfiguration("v1", "BitcoinCash API");
                });
                ...
                {
                    new BitcoinCashApiModule (appSettings.Nested(x => x.BitcoinCashApi), Log),
